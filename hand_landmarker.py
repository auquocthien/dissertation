# -*- coding: utf-8 -*-
"""Copy of hand_landmarker.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1eE_YeeuCyaSIGXDCOGloACHsODpwr69P
...
def to_gif(images, duration):
    ...
    imageio.mimsave('./animation2.gif', images, duration=duration)
...
# image_path = 'dataset\D0007.mp4'
# image = get_video_assarray(image_path)

# print(image.shape)

image = mp.Image.create_from_file("_103906767_gettyimages-627873774.jpg")
ouput_image = []
...
#     ouput_image.append(annotated_image)
